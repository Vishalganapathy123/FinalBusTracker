...
public class AdminResource {
    ...
    public Response updateBus(Bus bus) {
        ...
        return Response.ok("Bus Updated Successfully")
                .build();
    ...
    public Response deleteBus(@PathParam("busId") String busId) {
        ...
        return Response.ok("Bus Deleted Successfully")
                .build();
 ...
 public Response updateStop(Stop stop) {
     ...
     return Response.ok("Stop Updated Successfully")
             .build();
 ...
 public Response deleteStop(@PathParam("stopId") String stopId) {
     ...
     return Response.ok("Stop Deleted Successfully")
             .build();
...
public Response updateRoute(Route route) {
  ...
  return Response.ok("Route Updated Successfully")
          .build();
...
public Response deleteRoute(@PathParam("routeId") String routeId) {
  ...
  return Response.ok("Route Deleted Successfully")
          .build();
...
public Response updateSchedule(Schedule schedule) {
 ...
 return Response.ok("Schedule Updated Successfully")
         .build();
...
public Response updateBusLocation(BusLocation location) {
 ...
 return Response.ok("Bus Location Updated Successfully")
         .build();
...
public Response deleteBusLocation(@PathParam("busId") String busId) {
 ...
 return Response.ok("Bus Location Deleted Successfully")
         .build();
